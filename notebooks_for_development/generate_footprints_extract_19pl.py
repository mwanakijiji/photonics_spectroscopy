...
# wavelength soln
df_wavel_soln_shift = basic_fcns.wavel_soln()
...
import ipdb; ipdb.set_trace()
# degree of (x,y) translation, and detector readout
x_shift, y_shift, D = basic_fcns.get_detector_array_and_shift(data_choice, bb_array, dark, canvas_array, rel_pos, sigma=sigma_all)



import ipdb; ipdb.set_trace()

df_wavel_soln_shift = basic_fcns.gen_spec_profile_and_wavel(rel_pos, x_shift, y_shift, canvas_array, test_array, df_wavel_soln_shift, wavel_soln_ports, dict_profiles, len_spec, sigma_all)
...
eta_wavel = basic_fcns.apply_wavel_solns(x_shift, y_shift, len_spec, rel_pos, canvas_array, wavel_soln_ports)
